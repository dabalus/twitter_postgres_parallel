...
![](https://github.com/dabalus/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/dabalus/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/dabalus/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/dabalus/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/dabalus/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/dabalus/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------|
| `pg_normalized`        |7:20.78                    | 0:56.49                 | 
| `pg_normalized_batch`  |1:43.37                    |  0:14.68                | 
| `pg_denormalized`      | 0.00.89                   | 0:03.90                 | 
